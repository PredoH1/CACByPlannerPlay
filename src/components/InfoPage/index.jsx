    ...
    <section ref={ref} className={styles.body}>
      ...
      <div className={styles.container}>
        ...
        <p>
          ...
          garantir a satisfação dos nossos clientes. Nossa ferramenta foi criada
          para simplificar a análise de dados, oferecendo insights valiosos para
          impulsionar a performance da sua empresa.
        </p>
      </div>
